...
def liquify(brush_radius, brush_center_start, brush_center_dst, pressure, rDx, rDy, uniform_brush=False):
    ...
    rDx, rDy = calc_rDx_rDy(
        img_width, img_height, mask, start_pt_a, start_pt_b, brush_radius, brush_center_start,
...
if __name__ == "__main__":
    ...
    for i in range(1):
        rDx, rDy = liquify(
            ...
            np.array([random.randint(10, 800), random.randint(10, 800)]),
            np.array([random.randint(10, 800), random.randint(10, 1000)]), 
            0.5, rDx, rDy, uniform_brush=False,
        )
